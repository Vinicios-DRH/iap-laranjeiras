...
class FormInscricaoTorneio(FlaskForm):
    ...
    jogador_1 = StringField('Jogador 1')
    jogador_2 = StringField('Jogador 2')
    jogador_3 = StringField('Jogador 3')
    jogador_4 = StringField('Jogador 4')
    jogador_5 = StringField('Jogador 5')
    jogador_6 = StringField('Jogador 6')
    jogador_7 = StringField('Jogador 7')
    jogador_8 = StringField('Jogador 8')
    jogador_9 = StringField('Jogador 9')
    jogador_10 = StringField('Jogador 10')
